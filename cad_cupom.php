...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <h1 class="mt-3">Cadastro de Cupons</h1>
            ...
            <form>
                ...
                <div class="form-group mt-5 row">
                    ...
                    <div class="col-md-4">
                        <input type="number" min="1" max="100" class="form-control" id="percent">
                    </div>
                </div>

                <div class="dropdown-divider"></div>
                <div class="col text-center">
                    <button type="button" class="btn btn-dark mb-5 mt-5" id="submit_btn" onclick="cadCupom()">Salvar</button>
            </form>
        </div>
    </div>
